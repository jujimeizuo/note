...
<center><img src="/assets/images/cv/3dv/ray-casting.jpg" width="50%" alt="光线投射体绘制算法"></center>
...
<center><img src="/assets/images/cv/3dv/promote-ray-casting.jpg" width="50%" alt="改进光线投射体绘制算法"></center>

### 物体空间扫描的体绘制技术

- 足迹表法：逐层、逐行、逐个地计算每一个数据点对屏幕像素的贡献，并加以合成，形成最后的图像

<center><img src="/assets/images/cv/3dv/footprint-table-method.jpg" width="50%" alt="足迹表法"></center>
...
<center><img src="/assets/images/cv/3dv/miscut-deformed.jpg" width="50%" alt="错切-变形算法"></center>
...
<center><img src="/assets/images/cv/3dv/casc.jpg" width="50%" alt="基于物质分类的颜色赋值的频域体绘制算法"></center>
