...
<center><img src="/assets/images/llm/transformer/bert/tf.png" alt="预训练+微调"></center>

## 模型结构

BERT模型的结构如下图最左：

<center><img src="/assets/images/llm/transformer/bert/bert-structure.png" alt="BERT模型结构"></center>
...
<center><img src="/assets/images/llm/transformer/bert/embedding.png"></center>
...
<center><img src="/assets/images/llm/transformer/bert/fine-tuning.png"></center>
